...
class DataSourceDescriptor(_message.Message):
    __slots__ = ("name", "id", "will_notify_on_stop", "will_notify_on_start", "handles_incremental_state_clear", "gpu_counter_descriptor", "track_event_descriptor", "ftrace_descriptor")
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class TracingServiceState(_message.Message):
    ...
    class TracingSession(_message.Message):
        __slots__ = ("id", "consumer_uid", "state", "unique_session_name", "buffer_size_kb", "duration_ms", "num_data_sources", "start_realtime_ns")
        ID_FIELD_NUMBER: _ClassVar[int]
...
class ChromeConfig(_message.Message):
    __slots__ = ("trace_config", "privacy_filtering_enabled", "convert_to_legacy_json", "client_priority", "json_agent_label_filter")
...
class FtraceConfig(_message.Message):
    __slots__ = ("ftrace_events", "atrace_categories", "atrace_apps", "buffer_size_kb", "drain_period_ms", "compact_sched", "print_filter", "symbolize_ksyms", "ksyms_mem_policy", "initialize_ksyms_synchronously_for_testing", "throttle_rss_stat", "disable_generic_events", "syscall_events", "enable_function_graph", "function_filters", "function_graph_roots", "preserve_ftrace_buffer", "use_monotonic_raw_clock", "instance_name")
...
class ProcessStatsConfig(_message.Message):
    __slots__ = ("quirks", "scan_all_processes_on_start", "record_thread_names", "proc_stats_poll_ms", "proc_stats_cache_ttl_ms", "resolve_process_fds", "scan_smaps_rollup")
    ...
    def __init__(self, quirks: _Optional[_Iterable[_Union[ProcessStatsConfig.Quirks, str]]] = ..., scan_all_processes_on_start: bool = ..., record_thread_names: bool = ..., proc_stats_poll_ms: _Optional[int] = ..., proc_stats_cache_ttl_ms: _Optional[int] = ..., resolve_process_fds: bool = ..., scan_smaps_rollup: bool = ...) -> None: ...
...
class PerfEventConfig(_message.Message):
    __slots__ = ("timebase", "callstack_sampling", "ring_buffer_read_period_ms", "ring_buffer_pages", "max_enqueued_footprint_kb", "max_daemon_memory_kb", "remote_descriptor_timeout_ms", "unwind_state_clear_period_ms", "target_installed_by", "all_cpus", "sampling_frequency", "kernel_frames", "target_pid", "target_cmdline", "exclude_pid", "exclude_cmdline", "additional_cmdline_count")
...
class SysStatsConfig(_message.Message):
    __slots__ = ("meminfo_period_ms", "meminfo_counters", "vmstat_period_ms", "vmstat_counters", "stat_period_ms", "stat_counters", "devfreq_period_ms", "cpufreq_period_ms", "buddyinfo_period_ms", "diskstat_period_ms")
...
class TrackEventConfig(_message.Message):
    __slots__ = ("disabled_categories", "enabled_categories", "disabled_tags", "enabled_tags", "disable_incremental_timestamps", "timestamp_unit_multiplier", "filter_debug_annotations", "enable_thread_time_sampling", "filter_dynamic_event_names")
...
class DataSourceConfig(_message.Message):
    __slots__ = ("name", "target_buffer", "trace_duration_ms", "prefer_suspend_clock_for_duration", "stop_timeout_ms", "enable_extra_guardrails", "session_initiator", "tracing_session_id", "ftrace_config", "inode_file_config", "process_stats_config", "sys_stats_config", "heapprofd_config", "java_hprof_config", "android_power_config", "android_log_config", "gpu_counter_config", "android_game_intervention_list_config", "packages_list_config", "perf_event_config", "vulkan_memory_config", "track_event_config", "android_polled_state_config", "android_system_property_config", "statsd_tracing_config", "system_info_config", "chrome_config", "interceptor_config", "network_packet_trace_config", "surfaceflinger_layers_config", "legacy_config", "for_testing")
...
class TraceConfig(_message.Message):
    ...
    COMPRESS_FROM_CLI_FIELD_NUMBER: _ClassVar[int]
...
class TraceStats(_message.Message):
    ...
    class WriterStats(_message.Message):
        __slots__ = ("sequence_id", "chunk_payload_histogram_counts", "chunk_payload_histogram_sum")
        ...
        def __init__(self, sequence_id: _Optional[int] = ..., chunk_payload_histogram_counts: _Optional[_Iterable[int]] = ..., chunk_payload_histogram_sum: _Optional[_Iterable[int]] = ...) -> None: ...
    class FilterStats(_message.Message):
        __slots__ = ("input_packets", "input_bytes", "output_bytes", "errors", "time_taken_ns")
        ...
        errors: int
        time_taken_ns: int
        def __init__(self, input_packets: _Optional[int] = ..., input_bytes: _Optional[int] = ..., output_bytes: _Optional[int] = ..., errors: _Optional[int] = ..., time_taken_ns: _Optional[int] = ...) -> None: ...
...
class AndroidCameraSessionStats(_message.Message):
    ...
    class CameraGraph(_message.Message):
        ...
        class CameraEdge(_message.Message):
            __slots__ = ("output_node_id", "output_id", "input_node_id", "input_id", "vendor_data_version", "vendor_data")
...
class FrameTimelineEvent(_message.Message):
    __slots__ = ("expected_display_frame_start", "actual_display_frame_start", "expected_surface_frame_start", "actual_surface_frame_start", "frame_end")
    ...
    class ActualSurfaceFrameStart(_message.Message):
        __slots__ = ("cookie", "token", "display_frame_token", "pid", "layer_name", "present_type", "on_time_finish", "gpu_composition", "jank_type", "prediction_type", "is_buffer")
        COOKIE_FIELD_NUMBER: _ClassVar[int]
        TOKEN_FIELD_NUMBER: _ClassVar[int]
        DISPLAY_FRAME_TOKEN_FIELD_NUMBER: _ClassVar[int]
        PID_FIELD_NUMBER: _ClassVar[int]
    ...
    class ActualDisplayFrameStart(_message.Message):
        __slots__ = ("cookie", "token", "pid", "present_type", "on_time_finish", "gpu_composition", "jank_type", "prediction_type")
        COOKIE_FIELD_NUMBER: _ClassVar[int]
        TOKEN_FIELD_NUMBER: _ClassVar[int]
        PID_FIELD_NUMBER: _ClassVar[int]
        PRESENT_TYPE_FIELD_NUMBER: _ClassVar[int]
...
class NetworkPacketEvent(_message.Message):
    __slots__ = ("direction", "interface", "length", "uid", "tag", "ip_proto", "tcp_flags", "local_port", "remote_port")
...
class BlurRegion(_message.Message):
    __slots__ = ("blur_radius", "corner_radius_tl", "corner_radius_tr", "corner_radius_bl", "corner_radius_br", "alpha", "left", "top", "right", "bottom")
...
class DisplayProto(_message.Message):
    __slots__ = ("id", "name", "layer_stack", "size", "layer_stack_space_rect", "transform", "is_virtual")
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class TransactionState(_message.Message):
    __slots__ = ("pid", "uid", "vsync_id", "input_event_id", "post_time", "transaction_id", "layer_changes", "display_changes", "merged_transaction_ids")
    PID_FIELD_NUMBER: _ClassVar[int]
    UID_FIELD_NUMBER: _ClassVar[int]
    VSYNC_ID_FIELD_NUMBER: _ClassVar[int]
...
class BackgroundTracingMetadata(_message.Message):
    ...
    class TriggerRule(_message.Message):
        ...
        class TriggerType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            ...
            MONITOR_AND_DUMP_WHEN_SPECIFIC_HISTOGRAM_AND_VALUE: _ClassVar[BackgroundTracingMetadata.TriggerRule.TriggerType]
...
class ChromeTraceEvent(_message.Message):
    __slots__ = ("name", "timestamp", "phase", "thread_id", "duration", "thread_duration", "scope", "id", "flags", "category_group_name", "process_id", "thread_timestamp", "bind_id", "args", "name_index", "category_group_name_index")
    class Arg(_message.Message):
        __slots__ = ("name", "bool_value", "uint_value", "int_value", "double_value", "string_value", "pointer_value", "json_value", "traced_value", "name_index")
        NAME_FIELD_NUMBER: _ClassVar[int]
        BOOL_VALUE_FIELD_NUMBER: _ClassVar[int]
...
class Ext4DaReleaseSpaceFtraceEvent(_message.Message):
    __slots__ = ("dev", "ino", "i_blocks", "freed_blocks", "reserved_data_blocks", "reserved_meta_blocks", "allocated_meta_blocks", "mode")
    DEV_FIELD_NUMBER: _ClassVar[int]
    INO_FIELD_NUMBER: _ClassVar[int]
...
class Ext4DaUpdateReserveSpaceFtraceEvent(_message.Message):
    __slots__ = ("dev", "ino", "i_blocks", "used_blocks", "reserved_data_blocks", "reserved_meta_blocks", "allocated_meta_blocks", "quota_claim", "mode")
    DEV_FIELD_NUMBER: _ClassVar[int]
    INO_FIELD_NUMBER: _ClassVar[int]
    I_BLOCKS_FIELD_NUMBER: _ClassVar[int]
...
class Ext4DaWritePagesFtraceEvent(_message.Message):
    __slots__ = ("dev", "ino", "first_page", "nr_to_write", "sync_mode", "b_blocknr", "b_size", "b_state", "io_done", "pages_written")
    DEV_FIELD_NUMBER: _ClassVar[int]
    INO_FIELD_NUMBER: _ClassVar[int]
...
class Ext4MballocAllocFtraceEvent(_message.Message):
    __slots__ = ("dev", "ino", "orig_logical", "orig_start", "orig_group", "orig_len", "goal_logical", "goal_start", "goal_group", "goal_len", "result_logical", "result_start", "result_group", "result_len", "found", "groups", "buddy", "flags", "tail", "cr")
    DEV_FIELD_NUMBER: _ClassVar[int]
    INO_FIELD_NUMBER: _ClassVar[int]
...
class Ext4MballocPreallocFtraceEvent(_message.Message):
    __slots__ = ("dev", "ino", "orig_logical", "orig_start", "orig_group", "orig_len", "result_logical", "result_start", "result_group", "result_len")
    DEV_FIELD_NUMBER: _ClassVar[int]
    INO_FIELD_NUMBER: _ClassVar[int]
    ORIG_LOGICAL_FIELD_NUMBER: _ClassVar[int]
    ORIG_START_FIELD_NUMBER: _ClassVar[int]
...
class Ext4WritepagesFtraceEvent(_message.Message):
    __slots__ = ("dev", "ino", "nr_to_write", "pages_skipped", "range_start", "range_end", "writeback_index", "sync_mode", "for_kupdate", "range_cyclic")
    DEV_FIELD_NUMBER: _ClassVar[int]
    INO_FIELD_NUMBER: _ClassVar[int]
    NR_TO_WRITE_FIELD_NUMBER: _ClassVar[int]
...
class F2fsGetVictimFtraceEvent(_message.Message):
    __slots__ = ("dev", "type", "gc_type", "alloc_mode", "gc_mode", "victim", "ofs_unit", "pre_victim", "prefree", "free", "cost")
    DEV_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
...
class MmPageAllocExtfragFtraceEvent(_message.Message):
    __slots__ = ("alloc_migratetype", "alloc_order", "fallback_migratetype", "fallback_order", "page", "change_ownership", "pfn")
...
class MdpSsppChangeFtraceEvent(_message.Message):
    __slots__ = ("num", "play_cnt", "mixer", "stage", "flags", "format", "img_w", "img_h", "src_x", "src_y", "src_w", "src_h", "dst_x", "dst_y", "dst_w", "dst_h")
    NUM_FIELD_NUMBER: _ClassVar[int]
    PLAY_CNT_FIELD_NUMBER: _ClassVar[int]
...
class MdpPerfPrefillCalcFtraceEvent(_message.Message):
    __slots__ = ("pnum", "latency_buf", "ot", "y_buf", "y_scaler", "pp_lines", "pp_bytes", "post_sc", "fbc_bytes", "prefill_bytes")
    PNUM_FIELD_NUMBER: _ClassVar[int]
...
class MmShrinkSlabStartFtraceEvent(_message.Message):
    __slots__ = ("cache_items", "delta", "gfp_flags", "lru_pgs", "nr_objects_to_shrink", "pgs_scanned", "shr", "shrink", "total_scan", "nid", "priority")
...
class FtraceEvent(_message.Message):
    __slots__ = ("timestamp", "pid", "common_flags", "print", "sched_switch", "cpu_frequency", "cpu_frequency_limits", "cpu_idle", "clock_enable", "clock_disable", "clock_set_rate", "sched_wakeup", "sched_blocked_reason", "sched_cpu_hotplug", "sched_waking", "ipi_entry", "ipi_exit", "ipi_raise", "softirq_entry", "softirq_exit", "softirq_raise", "i2c_read", "i2c_write", "i2c_result", "i2c_reply", "smbus_read", "smbus_write", "smbus_result", "smbus_reply", "lowmemory_kill", "irq_handler_entry", "irq_handler_exit", "sync_pt", "sync_timeline", "sync_wait", "ext4_da_write_begin", "ext4_da_write_end", "ext4_sync_file_enter", "ext4_sync_file_exit", "block_rq_issue", "mm_vmscan_direct_reclaim_begin", "mm_vmscan_direct_reclaim_end", "mm_vmscan_kswapd_wake", "mm_vmscan_kswapd_sleep", "binder_transaction", "binder_transaction_received", "binder_set_priority", "binder_lock", "binder_locked", "binder_unlock", "workqueue_activate_work", "workqueue_execute_end", "workqueue_execute_start", "workqueue_queue_work", "regulator_disable", "regulator_disable_complete", "regulator_enable", "regulator_enable_complete", "regulator_enable_delay", "regulator_set_voltage", "regulator_set_voltage_complete", "cgroup_attach_task", "cgroup_mkdir", "cgroup_remount", "cgroup_rmdir", "cgroup_transfer_tasks", "cgroup_destroy_root", "cgroup_release", "cgroup_rename", "cgroup_setup_root", "mdp_cmd_kickoff", "mdp_commit", "mdp_perf_set_ot", "mdp_sspp_change", "tracing_mark_write", "mdp_cmd_pingpong_done", "mdp_compare_bw", "mdp_perf_set_panic_luts", "mdp_sspp_set", "mdp_cmd_readptr_done", "mdp_misr_crc", "mdp_perf_set_qos_luts", "mdp_trace_counter", "mdp_cmd_release_bw", "mdp_mixer_update", "mdp_perf_set_wm_levels", "mdp_video_underrun_done", "mdp_cmd_wait_pingpong", "mdp_perf_prefill_calc", "mdp_perf_update_bus", "rotator_bw_ao_as_context", "mm_filemap_add_to_page_cache", "mm_filemap_delete_from_page_cache", "mm_compaction_begin", "mm_compaction_defer_compaction", "mm_compaction_deferred", "mm_compaction_defer_reset", "mm_compaction_end", "mm_compaction_finished", "mm_compaction_isolate_freepages", "mm_compaction_isolate_migratepages", "mm_compaction_kcompactd_sleep", "mm_compaction_kcompactd_wake", "mm_compaction_migratepages", "mm_compaction_suitable", "mm_compaction_try_to_compact_pages", "mm_compaction_wakeup_kcompactd", "suspend_resume", "sched_wakeup_new", "block_bio_backmerge", "block_bio_bounce", "block_bio_complete", "block_bio_frontmerge", "block_bio_queue", "block_bio_remap", "block_dirty_buffer", "block_getrq", "block_plug", "block_rq_abort", "block_rq_complete", "block_rq_insert", "block_rq_remap", "block_rq_requeue", "block_sleeprq", "block_split", "block_touch_buffer", "block_unplug", "ext4_alloc_da_blocks", "ext4_allocate_blocks", "ext4_allocate_inode", "ext4_begin_ordered_truncate", "ext4_collapse_range", "ext4_da_release_space", "ext4_da_reserve_space", "ext4_da_update_reserve_space", "ext4_da_write_pages", "ext4_da_write_pages_extent", "ext4_direct_IO_enter", "ext4_direct_IO_exit", "ext4_discard_blocks", "ext4_discard_preallocations", "ext4_drop_inode", "ext4_es_cache_extent", "ext4_es_find_delayed_extent_range_enter", "ext4_es_find_delayed_extent_range_exit", "ext4_es_insert_extent", "ext4_es_lookup_extent_enter", "ext4_es_lookup_extent_exit", "ext4_es_remove_extent", "ext4_es_shrink", "ext4_es_shrink_count", "ext4_es_shrink_scan_enter", "ext4_es_shrink_scan_exit", "ext4_evict_inode", "ext4_ext_convert_to_initialized_enter", "ext4_ext_convert_to_initialized_fastpath", "ext4_ext_handle_unwritten_extents", "ext4_ext_in_cache", "ext4_ext_load_extent", "ext4_ext_map_blocks_enter", "ext4_ext_map_blocks_exit", "ext4_ext_put_in_cache", "ext4_ext_remove_space", "ext4_ext_remove_space_done", "ext4_ext_rm_idx", "ext4_ext_rm_leaf", "ext4_ext_show_extent", "ext4_fallocate_enter", "ext4_fallocate_exit", "ext4_find_delalloc_range", "ext4_forget", "ext4_free_blocks", "ext4_free_inode", "ext4_get_implied_cluster_alloc_exit", "ext4_get_reserved_cluster_alloc", "ext4_ind_map_blocks_enter", "ext4_ind_map_blocks_exit", "ext4_insert_range", "ext4_invalidatepage", "ext4_journal_start", "ext4_journal_start_reserved", "ext4_journalled_invalidatepage", "ext4_journalled_write_end", "ext4_load_inode", "ext4_load_inode_bitmap", "ext4_mark_inode_dirty", "ext4_mb_bitmap_load", "ext4_mb_buddy_bitmap_load", "ext4_mb_discard_preallocations", "ext4_mb_new_group_pa", "ext4_mb_new_inode_pa", "ext4_mb_release_group_pa", "ext4_mb_release_inode_pa", "ext4_mballoc_alloc", "ext4_mballoc_discard", "ext4_mballoc_free", "ext4_mballoc_prealloc", "ext4_other_inode_update_time", "ext4_punch_hole", "ext4_read_block_bitmap_load", "ext4_readpage", "ext4_releasepage", "ext4_remove_blocks", "ext4_request_blocks", "ext4_request_inode", "ext4_sync_fs", "ext4_trim_all_free", "ext4_trim_extent", "ext4_truncate_enter", "ext4_truncate_exit", "ext4_unlink_enter", "ext4_unlink_exit", "ext4_write_begin", "ext4_write_end", "ext4_writepage", "ext4_writepages", "ext4_writepages_result", "ext4_zero_range", "task_newtask", "task_rename", "sched_process_exec", "sched_process_exit", "sched_process_fork", "sched_process_free", "sched_process_hang", "sched_process_wait", "f2fs_do_submit_bio", "f2fs_evict_inode", "f2fs_fallocate", "f2fs_get_data_block", "f2fs_get_victim", "f2fs_iget", "f2fs_iget_exit", "f2fs_new_inode", "f2fs_readpage", "f2fs_reserve_new_block", "f2fs_set_page_dirty", "f2fs_submit_write_page", "f2fs_sync_file_enter", "f2fs_sync_file_exit", "f2fs_sync_fs", "f2fs_truncate", "f2fs_truncate_blocks_enter", "f2fs_truncate_blocks_exit", "f2fs_truncate_data_blocks_range", "f2fs_truncate_inode_blocks_enter", "f2fs_truncate_inode_blocks_exit", "f2fs_truncate_node", "f2fs_truncate_nodes_enter", "f2fs_truncate_nodes_exit", "f2fs_truncate_partial_nodes", "f2fs_unlink_enter", "f2fs_unlink_exit", "f2fs_vm_page_mkwrite", "f2fs_write_begin", "f2fs_write_checkpoint", "f2fs_write_end", "alloc_pages_iommu_end", "alloc_pages_iommu_fail", "alloc_pages_iommu_start", "alloc_pages_sys_end", "alloc_pages_sys_fail", "alloc_pages_sys_start", "dma_alloc_contiguous_retry", "iommu_map_range", "iommu_sec_ptbl_map_range_end", "iommu_sec_ptbl_map_range_start", "ion_alloc_buffer_end", "ion_alloc_buffer_fail", "ion_alloc_buffer_fallback", "ion_alloc_buffer_start", "ion_cp_alloc_retry", "ion_cp_secure_buffer_end", "ion_cp_secure_buffer_start", "ion_prefetching", "ion_secure_cma_add_to_pool_end", "ion_secure_cma_add_to_pool_start", "ion_secure_cma_allocate_end", "ion_secure_cma_allocate_start", "ion_secure_cma_shrink_pool_end", "ion_secure_cma_shrink_pool_start", "kfree", "kmalloc", "kmalloc_node", "kmem_cache_alloc", "kmem_cache_alloc_node", "kmem_cache_free", "migrate_pages_end", "migrate_pages_start", "migrate_retry", "mm_page_alloc", "mm_page_alloc_extfrag", "mm_page_alloc_zone_locked", "mm_page_free", "mm_page_free_batched", "mm_page_pcpu_drain", "rss_stat", "ion_heap_shrink", "ion_heap_grow", "fence_init", "fence_destroy", "fence_enable_signal", "fence_signaled", "clk_enable", "clk_disable", "clk_set_rate", "binder_transaction_alloc_buf", "signal_deliver", "signal_generate", "oom_score_adj_update", "generic", "mm_event_record", "sys_enter", "sys_exit", "zero", "gpu_frequency", "sde_tracing_mark_write", "mark_victim", "ion_stat", "ion_buffer_create", "ion_buffer_destroy", "scm_call_start", "scm_call_end", "gpu_mem_total", "thermal_temperature", "cdev_update", "cpuhp_exit", "cpuhp_multi_enter", "cpuhp_enter", "cpuhp_latency", "fastrpc_dma_stat", "dpu_tracing_mark_write", "g2d_tracing_mark_write", "mali_tracing_mark_write", "dma_heap_stat", "cpuhp_pause", "sched_pi_setprio", "sde_sde_evtlog", "sde_sde_perf_calc_crtc", "sde_sde_perf_crtc_update", "sde_sde_perf_set_qos_luts", "sde_sde_perf_update_bus", "rss_stat_throttled", "netif_receive_skb", "net_dev_xmit", "inet_sock_set_state", "tcp_retransmit_skb", "cros_ec_sensorhub_data", "napi_gro_receive_entry", "napi_gro_receive_exit", "kfree_skb", "kvm_access_fault", "kvm_ack_irq", "kvm_age_hva", "kvm_age_page", "kvm_arm_clear_debug", "kvm_arm_set_dreg32", "kvm_arm_set_regset", "kvm_arm_setup_debug", "kvm_entry", "kvm_exit", "kvm_fpu", "kvm_get_timer_map", "kvm_guest_fault", "kvm_handle_sys_reg", "kvm_hvc_arm64", "kvm_irq_line", "kvm_mmio", "kvm_mmio_emulate", "kvm_set_guest_debug", "kvm_set_irq", "kvm_set_spte_hva", "kvm_set_way_flush", "kvm_sys_access", "kvm_test_age_hva", "kvm_timer_emulate", "kvm_timer_hrtimer_expire", "kvm_timer_restore_state", "kvm_timer_save_state", "kvm_timer_update_irq", "kvm_toggle_cache", "kvm_unmap_hva_range", "kvm_userspace_exit", "kvm_vcpu_wakeup", "kvm_wfx_arm64", "trap_reg", "vgic_update_irq_pending", "wakeup_source_activate", "wakeup_source_deactivate", "ufshcd_command", "ufshcd_clk_gating", "console", "drm_vblank_event", "drm_vblank_event_delivered", "drm_sched_job", "drm_run_job", "drm_sched_process_job", "dma_fence_init", "dma_fence_emit", "dma_fence_signaled", "dma_fence_wait_start", "dma_fence_wait_end", "f2fs_iostat", "f2fs_iostat_latency", "sched_cpu_util_cfs", "v4l2_qbuf", "v4l2_dqbuf", "vb2_v4l2_buf_queue", "vb2_v4l2_buf_done", "vb2_v4l2_qbuf", "vb2_v4l2_dqbuf", "dsi_cmd_fifo_status", "dsi_rx", "dsi_tx", "android_fs_dataread_end", "android_fs_dataread_start", "android_fs_datawrite_end", "android_fs_datawrite_start", "android_fs_fsync_end", "android_fs_fsync_start", "funcgraph_entry", "funcgraph_exit", "virtio_video_cmd", "virtio_video_cmd_done", "virtio_video_resource_queue", "virtio_video_resource_queue_done", "mm_shrink_slab_start", "mm_shrink_slab_end", "trusty_smc", "trusty_smc_done", "trusty_std_call32", "trusty_std_call32_done", "trusty_share_memory", "trusty_share_memory_done", "trusty_reclaim_memory", "trusty_reclaim_memory_done", "trusty_irq", "trusty_ipc_handle_event", "trusty_ipc_connect", "trusty_ipc_connect_end", "trusty_ipc_write", "trusty_ipc_poll", "trusty_ipc_read", "trusty_ipc_read_end", "trusty_ipc_rx", "trusty_enqueue_nop", "cma_alloc_start", "cma_alloc_info", "lwis_tracing_mark_write", "virtio_gpu_cmd_queue", "virtio_gpu_cmd_response", "mali_mali_KCPU_CQS_SET", "mali_mali_KCPU_CQS_WAIT_START", "mali_mali_KCPU_CQS_WAIT_END", "mali_mali_KCPU_FENCE_SIGNAL", "mali_mali_KCPU_FENCE_WAIT_START", "mali_mali_KCPU_FENCE_WAIT_END", "hyp_enter", "hyp_exit", "host_hcall", "host_smc", "host_mem_abort", "suspend_resume_minimal", "mali_mali_CSF_INTERRUPT_START", "mali_mali_CSF_INTERRUPT_END")
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    PID_FIELD_NUMBER: _ClassVar[int]
...
class FtraceCpuStats(_message.Message):
    __slots__ = ("cpu", "entries", "overrun", "commit_overrun", "bytes_read", "oldest_event_ts", "now_ts", "dropped_events", "read_events")
    CPU_FIELD_NUMBER: _ClassVar[int]
    ENTRIES_FIELD_NUMBER: _ClassVar[int]
    OVERRUN_FIELD_NUMBER: _ClassVar[int]
...
class FtraceStats(_message.Message):
    __slots__ = ("phase", "cpu_stats", "kernel_symbols_parsed", "kernel_symbols_mem_kb", "atrace_errors", "unknown_ftrace_events", "failed_ftrace_events", "preserve_ftrace_buffer")
...
class GpuRenderStageEvent(_message.Message):
    __slots__ = ("event_id", "duration", "hw_queue_iid", "stage_iid", "gpu_id", "context", "render_target_handle", "submission_id", "extra_data", "render_pass_handle", "render_subpass_index_mask", "command_buffer_handle", "specifications", "hw_queue_id", "stage_id")
    Extensions: _python_message._ExtensionDict
...
class VulkanMemoryEvent(_message.Message):
    __slots__ = ("source", "operation", "timestamp", "pid", "memory_address", "memory_size", "caller_iid", "allocation_scope", "annotations", "device", "device_memory", "memory_type", "heap", "object_handle")
...
class DebugAnnotation(_message.Message):
    __slots__ = ("name_iid", "name", "bool_value", "uint_value", "int_value", "double_value", "pointer_value", "nested_value", "legacy_json_value", "string_value", "string_value_iid", "proto_type_name", "proto_type_name_iid", "proto_value", "dict_entries", "array_values")
...
class ChromeCompositorSchedulerState(_message.Message):
    __slots__ = ("state_machine", "observing_begin_frame_source", "begin_impl_frame_deadline_task", "pending_begin_frame_task", "skipped_last_frame_missed_exceeded_deadline", "inside_action", "deadline_mode", "deadline_us", "deadline_scheduled_at_us", "now_us", "now_to_deadline_delta_us", "now_to_deadline_scheduled_at_delta_us", "begin_impl_frame_args", "begin_frame_observer_state", "begin_frame_source_state", "compositor_timing_history")
...
class ChromeCompositorStateMachine(_message.Message):
    ...
    class MajorState(_message.Message):
        __slots__ = ("next_action", "begin_impl_frame_state", "begin_main_frame_state", "layer_tree_frame_sink_state", "forced_redraw_state")
        ...
        class LayerTreeFrameSinkState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            ...
            LAYER_TREE_FRAME_WAITING_FOR_FIRST_COMMIT: _ClassVar[ChromeCompositorStateMachine.MajorState.LayerTreeFrameSinkState]
            LAYER_TREE_FRAME_WAITING_FOR_FIRST_ACTIVATION: _ClassVar[ChromeCompositorStateMachine.MajorState.LayerTreeFrameSinkState]
        ...
        class ForcedRedrawOnTimeoutState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            ...
            FORCED_REDRAW_WAITING_FOR_COMMIT: _ClassVar[ChromeCompositorStateMachine.MajorState.ForcedRedrawOnTimeoutState]
            FORCED_REDRAW_WAITING_FOR_ACTIVATION: _ClassVar[ChromeCompositorStateMachine.MajorState.ForcedRedrawOnTimeoutState]
            FORCED_REDRAW_WAITING_FOR_DRAW: _ClassVar[ChromeCompositorStateMachine.MajorState.ForcedRedrawOnTimeoutState]
    ...
    class MinorState(_message.Message):
        __slots__ = ("commit_count", "current_frame_number", "last_frame_number_submit_performed", "last_frame_number_draw_performed", "last_frame_number_begin_main_frame_sent", "did_draw", "did_send_begin_main_frame_for_current_frame", "did_notify_begin_main_frame_not_expected_until", "did_notify_begin_main_frame_not_expected_soon", "wants_begin_main_frame_not_expected", "did_commit_during_frame", "did_invalidate_layer_tree_frame_sink", "did_perform_impl_side_invalidaion", "did_prepare_tiles", "consecutive_checkerboard_animations", "pending_submit_frames", "submit_frames_with_current_layer_tree_frame_sink", "needs_redraw", "needs_prepare_tiles", "needs_begin_main_frame", "needs_one_begin_impl_frame", "visible", "begin_frame_source_paused", "can_draw", "resourceless_draw", "has_pending_tree", "pending_tree_is_ready_for_activation", "active_tree_needs_first_draw", "active_tree_is_ready_to_draw", "did_create_and_initialize_first_layer_tree_frame_sink", "tree_priority", "scroll_handler_state", "critical_begin_main_frame_to_activate_is_fast", "main_thread_missed_last_deadline", "video_needs_begin_frames", "defer_begin_main_frame", "last_commit_had_no_updates", "did_draw_in_last_frame", "did_submit_in_last_frame", "needs_impl_side_invalidation", "current_pending_tree_is_impl_side", "previous_pending_tree_was_impl_side", "processing_animation_worklets_for_active_tree", "processing_animation_worklets_for_pending_tree", "processing_paint_worklets_for_pending_tree")
...
class BeginFrameArgs(_message.Message):
    __slots__ = ("type", "source_id", "sequence_number", "frame_time_us", "deadline_us", "interval_delta_us", "on_critical_path", "animate_only", "source_location_iid", "source_location", "frames_throttled_since_last")
...
class BeginImplFrameArgs(_message.Message):
    ...
    class TimestampsInUs(_message.Message):
        __slots__ = ("interval_delta", "now_to_deadline_delta", "frame_time_to_now_delta", "frame_time_to_deadline_delta", "now", "frame_time", "deadline")
...
class CompositorTimingHistory(_message.Message):
    __slots__ = ("begin_main_frame_queue_critical_estimate_delta_us", "begin_main_frame_queue_not_critical_estimate_delta_us", "begin_main_frame_start_to_ready_to_commit_estimate_delta_us", "commit_to_ready_to_activate_estimate_delta_us", "prepare_tiles_estimate_delta_us", "activate_estimate_delta_us", "draw_estimate_delta_us")
...
class ChromeFrameReporter(_message.Message):
    __slots__ = ("state", "reason", "frame_source", "frame_sequence", "affects_smoothness", "scroll_state", "has_main_animation", "has_compositor_animation", "has_smooth_input_main", "has_missing_content", "layer_tree_host_id", "has_high_latency", "frame_type", "high_latency_contribution_stage")
    class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
...
class ChromeLatencyInfo(_message.Message):
    __slots__ = ("trace_id", "step", "frame_tree_node_id", "component_info", "is_coalesced", "gesture_scroll_id", "touch_id")
...
class ChromeMojoEventInfo(_message.Message):
    __slots__ = ("watcher_notify_interface_tag", "ipc_hash", "mojo_interface_tag", "mojo_interface_method_iid", "is_reply", "payload_size", "data_num_bytes")
...
class TrackEvent(_message.Message):
    __slots__ = ("category_iids", "categories", "name_iid", "name", "type", "track_uuid", "counter_value", "double_counter_value", "extra_counter_track_uuids", "extra_counter_values", "extra_double_counter_track_uuids", "extra_double_counter_values", "flow_ids_old", "flow_ids", "terminating_flow_ids_old", "terminating_flow_ids", "debug_annotations", "task_execution", "log_message", "cc_scheduler_state", "chrome_user_event", "chrome_keyed_service", "chrome_legacy_ipc", "chrome_histogram_sample", "chrome_latency_info", "chrome_frame_reporter", "chrome_application_state_info", "chrome_renderer_scheduler_state", "chrome_window_handle_event_info", "chrome_content_settings_event_info", "chrome_active_processes", "source_location", "source_location_iid", "chrome_message_pump", "chrome_mojo_event_info", "timestamp_delta_us", "timestamp_absolute_us", "thread_time_delta_us", "thread_time_absolute_us", "thread_instruction_count_delta", "thread_instruction_count_absolute", "legacy_event")
    Extensions: _python_message._ExtensionDict
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
...
class InternedData(_message.Message):
    __slots__ = ("event_categories", "event_names", "debug_annotation_names", "debug_annotation_value_type_names", "source_locations", "unsymbolized_source_locations", "log_message_body", "histogram_names", "build_ids", "mapping_paths", "source_paths", "function_names", "profiled_frame_symbols", "mappings", "frames", "callstacks", "vulkan_memory_keys", "graphics_contexts", "gpu_specifications", "kernel_symbols", "debug_annotation_string_values", "packet_context")
...
class PerfettoMetatrace(_message.Message):
    __slots__ = ("event_id", "counter_id", "event_name", "event_name_iid", "counter_name", "event_duration_ns", "counter_value", "thread_id", "has_overruns", "args", "interned_strings")
    class Arg(_message.Message):
...
class TracingServiceEvent(_message.Message):
    __slots__ = ("tracing_started", "all_data_sources_started", "all_data_sources_flushed", "read_tracing_buffers_completed", "tracing_disabled", "seized_for_bugreport")
...
class EntityStateResidency(_message.Message):
    ...
    class StateResidency(_message.Message):
        __slots__ = ("entity_index", "state_index", "total_time_in_state_ms", "total_state_entry_count", "last_entry_timestamp_ms")
        ENTITY_INDEX_FIELD_NUMBER: _ClassVar[int]
        STATE_INDEX_FIELD_NUMBER: _ClassVar[int]
...
class BatteryCounters(_message.Message):
    __slots__ = ("charge_counter_uah", "capacity_percent", "current_ua", "current_avg_ua", "name", "energy_counter_uwh", "voltage_uv")
...
class HeapGraphObject(_message.Message):
    __slots__ = ("id", "id_delta", "type_id", "self_size", "reference_field_id_base", "reference_field_id", "reference_object_id", "native_allocation_registry_size_field")
    ID_FIELD_NUMBER: _ClassVar[int]
...
class ProfilePacket(_message.Message):
    ...
    class HeapSample(_message.Message):
        __slots__ = ("callstack_id", "self_allocated", "self_freed", "self_max", "self_max_count", "timestamp", "alloc_count", "free_count")
    ...
    class ProcessStats(_message.Message):
        __slots__ = ("unwinding_errors", "heap_samples", "map_reparses", "unwinding_time_us", "total_unwinding_time_us", "client_spinlock_blocked_us")
...
class PerfSample(_message.Message):
    __slots__ = ("cpu", "pid", "tid", "cpu_mode", "timebase_count", "callstack_iid", "unwind_error", "kernel_records_lost", "sample_skipped_reason", "producer_event")
...
class SmapsEntry(_message.Message):
    __slots__ = ("path", "size_kb", "private_dirty_kb", "swap_kb", "file_name", "start_address", "module_timestamp", "module_debugid", "module_debug_path", "protection_flags", "private_clean_resident_kb", "shared_dirty_resident_kb", "shared_clean_resident_kb", "locked_kb", "proportional_resident_kb")
    PATH_FIELD_NUMBER: _ClassVar[int]
    SIZE_KB_FIELD_NUMBER: _ClassVar[int]
...
class ProcessStats(_message.Message):
    ...
    class Process(_message.Message):
        __slots__ = ("pid", "vm_size_kb", "vm_rss_kb", "rss_anon_kb", "rss_file_kb", "rss_shmem_kb", "vm_swap_kb", "vm_locked_kb", "vm_hwm_kb", "oom_score_adj", "threads", "is_peak_rss_resettable", "chrome_private_footprint_kb", "chrome_peak_resident_set_kb", "fds", "smr_rss_kb", "smr_pss_kb", "smr_pss_anon_kb", "smr_pss_file_kb", "smr_pss_shmem_kb")
        PID_FIELD_NUMBER: _ClassVar[int]
...
class SysStats(_message.Message):
    __slots__ = ("meminfo", "vmstat", "cpu_stat", "num_forks", "num_irq_total", "num_irq", "num_softirq_total", "num_softirq", "collection_end_timestamp", "devfreq", "cpufreq_khz", "buddy_info", "disk_stat")
    ...
    class CpuTimes(_message.Message):
        __slots__ = ("cpu_id", "user_ns", "user_ice_ns", "system_mode_ns", "idle_ns", "io_wait_ns", "irq_ns", "softirq_ns")
        CPU_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    class DiskStat(_message.Message):
        __slots__ = ("device_name", "read_sectors", "read_time_ms", "write_sectors", "write_time_ms", "discard_sectors", "discard_time_ms", "flush_count", "flush_time_ms")
...
class SystemInfo(_message.Message):
    __slots__ = ("utsname", "android_build_fingerprint", "hz", "tracing_service_version", "android_sdk_version", "page_size")
...
class TestEvent(_message.Message):
    ...
    class TestPayload(_message.Message):
        __slots__ = ("str", "nested", "single_string", "single_int", "repeated_ints", "remaining_nesting_depth", "debug_annotations")
        STR_FIELD_NUMBER: _ClassVar[int]
...
class TracePacketDefaults(_message.Message):
    __slots__ = ("timestamp_clock_id", "track_event_defaults", "perf_sample_defaults")
...
class ProcessDescriptor(_message.Message):
    __slots__ = ("pid", "cmdline", "process_name", "process_priority", "start_timestamp_ns", "chrome_process_type", "legacy_sort_index", "process_labels")
...
class ThreadDescriptor(_message.Message):
    __slots__ = ("pid", "tid", "thread_name", "chrome_thread_type", "reference_timestamp_us", "reference_thread_time_us", "reference_thread_instruction_count", "legacy_sort_index")
...
class TrackDescriptor(_message.Message):
    __slots__ = ("uuid", "parent_uuid", "name", "process", "chrome_process", "thread", "chrome_thread", "counter", "disallow_merging_with_system_tracks")
